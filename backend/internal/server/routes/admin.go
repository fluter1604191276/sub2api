...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/smart-scheduler/policy", h.Admin.Group.GetSmartStickyPolicy)
		groups.PUT("/:id/smart-scheduler/policy", h.Admin.Group.UpdateSmartStickyPolicy)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/sync/models/preview", h.Admin.Account.PreviewAllModelMappings)
		accounts.POST("/sync/models/apply", h.Admin.Account.ApplyModelMappings)
		...
		accounts.POST("/cache-hit-stats/batch", h.Admin.Account.GetBatchCacheHitStats)
		accounts.POST("/quality-stats/batch", h.Admin.Account.GetBatchQualityStats)
		accounts.POST("/capability-stats/batch", h.Admin.Account.GetBatchCapabilityStats)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.GET("/model-calibration/preview", h.Admin.Channel.PreviewModelCalibration)
		channels.POST("/model-calibration/apply", h.Admin.Channel.ApplyModelCalibration)
