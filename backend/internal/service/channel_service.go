...
func NewChannelService(repo ChannelRepository, groupRepo GroupRepository, authCacheInvalidator APIKeyAuthCacheInvalidator, pricingService *PricingService, dependency any) *ChannelService {
	var accountRepo channelModelCalibrationAccountRepository
	var cachePubSub ChannelCachePubSub
	switch value := dependency.(type) {
	case channelModelCalibrationAccountRepository:
		accountRepo = value
	case ChannelCachePubSub:
		cachePubSub = value
	}
	s := &ChannelService{
		repo:                 repo,
