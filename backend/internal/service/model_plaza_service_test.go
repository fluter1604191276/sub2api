...
func TestLookupOfficialPricingSeparatesDomesticReferenceFromBilling(t *testing.T) {
	...
	require.Equal(t, "Official China peak pricing (CNY)", deepseek.PriceBasis)
	require.InDelta(t, 2e-6, *deepseek.InputPrice, 1e-15)
	require.InDelta(t, 8e-6, *deepseek.OutputPrice, 1e-15)
	require.InDelta(t, .04e-6, *deepseek.CacheReadPrice, 1e-15)
