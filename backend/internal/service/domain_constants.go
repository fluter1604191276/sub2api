...
const (
	...
	// SettingKeyChannelMonitorDailyBudgetUSD caps the standard-price estimate spent by
	// V1 active probes in one application-timezone day. Zero disables the cap.
	SettingKeyChannelMonitorDailyBudgetUSD = "channel_monitor_daily_budget_usd"
