...
var ProviderSet = wire.NewSet(
	...
	NewGroupRecoveryProbeRepository,
	wire.Bind(new(service.GroupRecoveryProbeRepository), new(*groupRecoveryProbeRepository)),
	wire.Bind(new(service.GroupRecoveryProbeBillingRepository), new(*groupRecoveryProbeRepository)),
	NewProxyRepository,
