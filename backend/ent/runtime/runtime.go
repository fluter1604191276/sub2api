...
func init() {
	...
	groupDescSmartSchedulerEnabled := groupFields[59].Descriptor()
	...
	groupDescRecoveryProbeEnabled := groupFields[60].Descriptor()
	...
	groupDescRecoveryProbeMode := groupFields[61].Descriptor()
	...
	groupDescRecoveryProbeModel := groupFields[62].Descriptor()
	...
	groupDescRecoveryProbeIntervalSeconds := groupFields[63].Descriptor()
	...
	groupDescRecoveryProbeAttemptsPerRound := groupFields[64].Descriptor()
	...
	groupDescRecoveryProbeIdleThresholdSeconds := groupFields[65].Descriptor()
	...
	groupDescRecoveryProbeBackoffCapSeconds := groupFields[66].Descriptor()
