...
func init() {
	...
	groupDescSmartSchedulerEnabled := groupFields[63].Descriptor()
	...
	groupDescRecoveryProbeEnabled := groupFields[64].Descriptor()
	...
	groupDescRecoveryProbeMode := groupFields[65].Descriptor()
	...
	groupDescRecoveryProbeModel := groupFields[66].Descriptor()
	...
	groupDescRecoveryProbeIntervalSeconds := groupFields[67].Descriptor()
	...
	groupDescRecoveryProbeAttemptsPerRound := groupFields[68].Descriptor()
	...
	groupDescRecoveryProbeIdleThresholdSeconds := groupFields[69].Descriptor()
	...
	groupDescRecoveryProbeBackoffCapSeconds := groupFields[70].Descriptor()
