    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          dailyBudget: 'Daily probe budget (USD)',
          dailyBudgetHint: 'Estimated at standard model prices. Set 0 for unlimited. Probes pause after the cap and resume the next day.',
