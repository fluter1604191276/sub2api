export default {
    ...
    groups: {
      ...
      smartScheduler: {
        ...
        description: 'Read-only preview. It does not take over production routing, change priorities, or run probes. The score combines recent quality, stable quality, attributed errors, cost multiplier, and live load.',
