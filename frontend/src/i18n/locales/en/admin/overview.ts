export default {
    ...
    groups: {
      ...
      smartScheduler: {
        action: 'Smart Scheduler',
        title: 'Smart Scheduler Preview · {name}',
        description: 'Preview the account pools and scores for this group. The score combines recent quality, stable quality, attributed errors, cost multiplier, and live load.',
        enabledStatus: 'This group takes over production routing with smart scheduling enabled.',
        disabledStatus: 'This group uses the original scheduler.',
        enableAction: 'Enable smart scheduling',
        ...
        recoveryProbe: {
          ...
          probesPerRound: 'Probes per round',
          smartBackoffMax: 'Smart backoff max (seconds)',
          idleThreshold: 'Idle threshold',
          idleThresholdFixed: 'Fixed 1h',
          noTestModel: 'not configured',
          summary: '{status} · {mode} · model {model} · interval {interval} · {count} per round · backoff max {backoff}',
          saveSuccess: 'Recovery probe settings saved',
          accountStatus: 'Probe status',
          noAccountStatus: 'No probe status',
          accountModel: 'model {model}',
          accountAttempts: '{successes} consecutive successes / {failures} failures, {total} total',
          accountLatency: 'latency {latency}',
          accountLastProbe: 'last {time}',
          accountNextProbe: 'next {time}',
          accountError: '{class}: {error}',
          unknownErrorClass: 'unknown error',
          billing: {
            title: 'Probe cost ledger',
            description: 'Charge actual probe consumption to your own site account at upstream-account cost, with a global daily budget. The dedicated key may stay inactive and is never used for external requests.',
            enabled: 'Charge my account',
            disabled: 'Do not charge',
            apiKey: 'Ledger API key',
            selectAPIKey: 'Select one of my keys',
            dailyBudget: 'Daily budget (USD)',
            perAttemptLimit: 'Per-attempt reserve (USD)',
            globalToday: 'Settled cost today',
            groupToday: 'Settled cost in group',
            budgetUsed: 'Budget used today',
            remaining: 'Budget remaining',
            settlementSummary: 'Settlement today',
            settlementCounts: '{settled} settled · {unavailable} unavailable · {failed} failed',
            hint: 'Probe rows are marked as Recovery probe and excluded from sales revenue, real traffic, and scheduler quality samples.',
            loadFailed: 'Failed to load probe billing settings',
            saveSuccess: 'Probe billing settings saved',
            saveFailed: 'Failed to save probe billing settings'
          },
          accountStatuses: {
            none: 'No state'
          },
	        ...
	        poolErrorPolicy: {
	          title: 'Group error and retry policy',
	          description: 'Overrides pool-mode and error-code policy for this group. Unset fields continue to inherit account or system defaults. Do not treat every 502/503 as an official overload.',
	          precedence: 'Precedence: explicit group settings > account settings > system defaults. The same account remains isolated per request group.',
	          poolMode: 'Pool mode',
	          retryCount: 'Same-account retries',
	          retryStatusCodes: 'Same-account retry codes',
	          retryStatusCodesPlaceholder: 'e.g. 529, comma-separated',
	          customEnabled: 'Custom error-code handling',
	          customCodes: 'Custom error codes',
	          customCodesPlaceholder: 'e.g. 401, 403; blank means an empty list',
	          inherit: 'Inherit',
	          override: 'Override',
	          enabled: 'Enabled',
	          disabled: 'Disabled',
	          inheritPlaceholder: 'Blank means inherit',
	          hint: 'Upstream 529 is already mapped to a client-retryable 503 and uses overload cooldown. Adding 529 as a custom error code stops scheduling that account instead.',
	          saveSuccess: 'Group error and retry policy saved'
	        },
	        formHint: 'When disabled, requests use the original scheduler. If scoring is abnormal, routing automatically falls back.',
        formEnabled: 'Enabled',
        formDisabled: 'Disabled',
        requestedModel: 'Requested model',
        requestedModelPlaceholder: 'Optional, e.g. claude-sonnet-4-6',
        endpoint: 'Endpoint',
        anyEndpoint: 'All endpoints',
        chatCompletions: 'Chat Completions',
        responses: 'Responses',
        messages: 'Messages',
        geminiModels: 'Gemini native',
        refresh: 'Refresh preview',
        generatedAt: 'Generated {time}',
        algorithm: 'Algorithm {version}',
        primary: 'Primary',
        warm: 'Warm observe',
        isolated: 'Isolated/excluded',
        ...
        exploration: 'Exploration preview',
        explorationRate: 'Explore {rate}',
        explorationCandidate: 'Explore candidate',
        probeBootstrap: 'Probe bootstrap',
        ...
        excluded: 'Excluded',
        noScore: 'Unscored',
        noEvidence: 'No real streaming evidence',
        noAccounts: 'No accounts are bound to this group',
        noModel: 'All models',
        failureSummary: 'Provider {provider} · transient {transient} · rate limit {rateLimit}',
        immediateFailureSummary: 'Last 5m immediate supplier failures: provider {provider} · transient {transient} · rate limit {rateLimit} · uncertain {uncertain}',
        clientSummary: 'Client {client} · platform {platform} · uncertain {uncertain}',
        capacityLimitedSummary: 'No-capacity events in last 1h: {count}. Capacity metrics are not included in account quality score.',
        loadSummary: '{current}/{max} concurrent · wait {waiting} · {rate}%',
        noLoad: 'No load snapshot',
        loadSnapshotWarning: 'Live load data was not fully included in this score',
        confidenceLabels: { high: 'High', medium: 'Medium', low: 'Low' },
        poolLabels: { primary: 'Primary', warm: 'Warm observe', isolated: 'Isolated/excluded' },
        error: 'Failed to load smart scheduler preview'
      },
