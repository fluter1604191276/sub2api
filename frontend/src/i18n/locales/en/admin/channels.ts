export default {
    ...
    channels: {
      ...
      modelCalibration: {
        ...
        safetyNote: 'Calibration only changes pricing-row model lists. Prices, billing modes, intervals, mappings, and group bindings stay unchanged. Models with an ambiguous price tier are skipped.',
        ...
        skipReasons: {
          ...
          would_empty_pricing: 'Removing this model would leave its pricing row empty, so it was preserved for review',
