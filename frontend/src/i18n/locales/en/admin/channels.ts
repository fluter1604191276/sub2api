export default {
    ...
    channels: {
      ...
      modelCalibration: {
        action: 'Calibrate Models',
        title: 'Channel Model Calibration',
        description: 'Align channel pricing model lists with model mappings from active, schedulable accounts in linked groups. Review the preview before applying.',
        loading: 'Analyzing account model mappings...',
        changedChannels: 'Channels changing',
        additions: 'Models added',
        removals: 'Stale models removed',
        skipped: 'Needs review',
        safetyNote: 'Calibration only adds models that uniquely match the pricing mode. Existing models are never removed, and prices, billing modes, intervals, mappings, and group bindings stay unchanged. Ambiguous items are skipped.',
        willChange: 'Safe to update',
        needsReview: 'Needs review',
        addLabel: 'Add',
        removeLabel: 'Remove',
        noChanges: 'Channel model lists are already aligned.',
        rowsToChange: '{count} pricing row(s) will change',
        apply: 'Apply Safe Changes',
        applying: 'Calibrating...',
        previewError: 'Failed to build the model calibration preview',
        applyError: 'Failed to apply model calibration',
        applySuccess: 'Model calibration completed. Updated {count} pricing row(s)',
        skipReasons: {
          no_target_models: 'No active, schedulable account model mappings are available for this linked platform',
          no_pricing: 'No pricing row exists for this platform, so a price cannot be selected',
          ambiguous_pricing: 'Multiple price tiers exist and no unique destination row can be determined',
          channel_mapping_source: 'This model is a channel mapping entry point and was preserved to keep the alias working',
          model_pattern_conflict: 'The model conflicts with an existing exact or wildcard pricing pattern',
          stale_model_review: 'The model is absent from current account mappings but may still be intentionally priced or temporarily unavailable, so it was preserved for review',
    ...
    channelMonitor: {
      ...
      budget: { today: 'Today probe estimate (including reservations)', exhausted: 'Daily cap reached; active probes paused', incomplete: 'Some probes could not be priced today; enabling a daily cap pauses paid probes until tomorrow' },
      bulkInterval: {
        open: 'Batch interval',
        title: 'Set probe interval in bulk',
        selectedCount: '{count} monitor(s) selected.',
        presetsLabel: 'Common probe intervals',
        hint: 'Use 15 seconds for fast status refresh. Existing jitter is automatically clamped to a safe range for the new interval.',
        invalid: 'Enter an integer between 15 and 3600 seconds.',
        apply: 'Apply settings',
        success: 'Updated the probe interval for {count} monitor(s)',
        failed: 'Failed to update probe intervals',
      },
