export default {
    accounts: {
      ...
      modelSync: {
        title: 'Sync upstream supported models', summary: '{changed} accounts changed ({total} total)', apply: 'Apply selected ({count})', applying: 'Applying...', applied: 'Applied {count} accounts, {conflicts} incomplete', applyFailed: 'Failed to apply model mappings', statusApplied: 'Applied', statusConflict: 'Account changed; preview again', statusFailed: 'Apply failed'
      },
