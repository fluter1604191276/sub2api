export default {
  ...
  availableChannels: {
    ...
    pricing: {
      ...
      effectivePrice: '{group}: channel base × current multiplier (reference)',
    ...
    categories: {
      ...
      domestic: 'Domestic', image: 'Image', other: 'Other'
    }
  },
  ...
  modelPlaza: {
    title: 'Model Plaza',
    description: 'Browse models, channels, groups, and user pricing available to this account',
    searchPlaceholder: 'Search models, channels, or groups...',
    filterLabel: 'Model plaza filters',
    summaryLabel: 'Model plaza overview',
    all: 'All', platform: 'Platform', group: 'Group', rate: 'Rate', category: 'Category',
    platformFilter: 'Platform filter', groupFilter: 'Group filter', rateFilter: 'Rate filter', categoryFilter: 'Model category filter',
    stats: { models: 'Models', channels: 'Channels', groups: 'Groups', visible: 'Visible' },
    channels: 'Available channels', groups: 'Available groups', modelsInGroup: 'models', noChannel: 'Unlabelled channel',
    pricing: 'User pricing', multiplePrices: 'Different source prices', noGroups: 'No visible groups', noMatches: 'No matching models',
    copyModel: 'Copy model name', copied: 'Model name copied', expand: 'Expand model details', collapse: 'Collapse model details',
    details: 'Available sources', sources: 'sources', model: 'Model', billing: 'Billing', input: 'Input', output: 'Output',
    cacheRead: 'Cache read', cacheWrite: 'Cache write', tiers: 'Price tiers', perToken: 'Per token', perRequest: 'Per request',
    perImage: 'Per image', tiered: 'Tiered pricing', loadError: 'Failed to load model plaza', categories: { all: 'All' },
    loading: 'Loading...',
    ...
    rateUnavailable: 'Your personal price could not be confirmed; showing the group effective price',
    ...
    table: {
      ...
      standardPrice: 'Group Effective Price',
      userPrice: 'My Effective Price',
      effectivePriceFormula: 'channel base price × effective rate',
