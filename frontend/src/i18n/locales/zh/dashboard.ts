export default {
  ...
  availableChannels: {
    ...
    pricing: {
      ...
      effectivePrice: '{group}：渠道基础价 × 当前倍率（参考）',
      multiplier: '基础价 × {rate}',
    ...
    categories: {
      ...
      domestic: '国产模型', image: '生图', other: '其他'
    }
  },
  ...
  modelPlaza: {
    ...
    stats: { models: '模型总数', channels: '渠道总数', groups: '分组总数', visible: '当前显示' },
    channels: '可用渠道',
    groups: '可用分组',
    modelsInGroup: '个模型',
    noChannel: '未标注渠道',
    ...
    rateUnavailable: '用户专属价格暂时无法确认，当前显示分组实付价',
    priceView: '价格口径',
    clearFilters: '清除筛选',
    summary: {
    ...
    table: {
      ...
      standardPrice: '分组实付价',
      userPrice: '我的实付价',
      effectivePriceFormula: '渠道基础价 × 生效倍率',
      officialPrice: '官方参考价',
      rate: '生效倍率',
      unitPerMillion: '$ / 1M token',
      perUnitRequest: '/ 次',
