export default {
    ...
    channels: {
      ...
      modelCalibration: {
        action: '一键校准模型',
        title: '渠道模型校准',
        description: '按渠道关联分组中启用且可调度账号的模型映射，校准渠道定价里的模型列表。请先核对预览再执行。',
        loading: '正在分析账号模型映射...',
        changedChannels: '将变更渠道',
        additions: '新增模型',
        removals: '移除过期模型',
        skipped: '需人工确认',
        safetyNote: '校准只新增能唯一匹配计费方式的模型，不自动删除现有模型，也不改价格、计费模式、区间、模型映射或分组绑定。歧义项会自动跳过。',
        willChange: '可安全更新',
        needsReview: '需人工确认',
        addLabel: '新增',
        removeLabel: '移除',
        noChanges: '当前渠道模型列表无需变更。',
        rowsToChange: '将更新 {count} 条定价记录',
        apply: '执行安全校准',
        applying: '正在校准...',
        previewError: '生成模型校准预览失败',
        applyError: '应用模型校准失败',
        applySuccess: '模型校准完成，已更新 {count} 条定价记录',
        skipReasons: {
          no_target_models: '关联分组没有可用于校准的启用且可调度账号模型映射',
          no_pricing: '该平台还没有定价记录，无法确定价格',
          ambiguous_pricing: '存在多个价格档，无法唯一判断应加入哪一条定价',
          channel_mapping_source: '该模型是渠道映射入口，已保留避免破坏别名调用',
          model_pattern_conflict: '与现有精确模型或通配符范围冲突，已跳过',
          stale_model_review: '账号映射中暂未出现，但可能仍有计费或临时兜底用途，已保留等待人工确认',
    ...
    channelMonitor: {
      ...
      loadError: '加载监控列表失败',
      selectMonitor: '选择监控',
      budget: { today: '今日探针估算花费（含预留）', exhausted: '已达到每日上限，主动探测已暂停', incomplete: '今日存在无法估价的探测；启用日上限后将暂停付费探测至次日' },
      bulkInterval: {
        open: '批量设置间隔',
        title: '批量设置探测间隔',
        selectedCount: '已选择 {count} 个监控。',
        presetsLabel: '常用探测间隔',
        hint: '设置为 15 秒可快速刷新渠道状态；系统会自动把不符合新间隔的随机抖动收敛到安全范围。',
        invalid: '请输入 15 到 3600 之间的整数秒数。',
        apply: '应用设置',
        success: '已更新 {count} 个监控的探测间隔',
        failed: '批量设置探测间隔失败',
      },
