...
CAPABILITY_FILES = {
    ...
    "channel-monitor-budget": (
        "backend/internal/service/channel_monitor_service.go",
        "backend/internal/repository/channel_monitor_repo.go",
        "backend/internal/repository/channel_monitor_budget_test.go",
        "backend/internal/service/channel_monitor_budget_test.go",
        "backend/migrations/232_channel_monitor_daily_budget.sql",
        "backend/migrations/233_channel_monitor_daily_budget_ledger.sql",
    ...
    "account-model-sync-preview": (
        ...
        "backend/internal/service/account_model_sync_preview_test.go",
