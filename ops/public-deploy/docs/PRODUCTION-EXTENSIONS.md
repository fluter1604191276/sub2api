...
| smart-probe-modes | Group sticky-escape policy presets and high-frequency streaming recovery probes with canonical monetary quantization before settlement | smart_sticky_policy.go, recovery probe runner/service/UI, migrations and tests | Account selection, probe load, upstream cost | Required |
