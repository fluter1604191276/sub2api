...
| pricing-calibration | Channel/model pricing calibration, explicit billing boundaries, and platform-aware display currency | channel calibration service/repository/tests, pricing routes, platform currency helper and catalog UI tests | User charges, loss risk, price interpretation | Required |
