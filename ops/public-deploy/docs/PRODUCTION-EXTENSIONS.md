...
| channel-monitor-budget | Daily estimated channel-monitor cost display and configurable application-timezone cap | channel_monitor_daily_rollup.go, channel monitor service/handler/settings/UI, budget migration and tests | Probe spend and monitoring availability | Required |
| smart-probe-modes | Group sticky-escape policy presets and high-frequency streaming recovery probes | smart_sticky_policy.go, recovery probe runner/service/UI, migrations and tests | Account selection, probe load, upstream cost | Required |
